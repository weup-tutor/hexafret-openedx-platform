...
class Command(BaseCommand):
    ...
    def get_user(self, username):
        try:
            ...
            raise CommandError(f'User {username} not found')  # pylint: disable=raise-missing-from  # noqa: B904
    ...
    def create_api_access_request(self, user, status, reason, website):
        ...
        try:
            ...
            if 'Permission denied' in error_msg and 'mako_lms' in error_msg:
                ...
                raise CommandError(error_msg)  # pylint: disable=raise-missing-from  # noqa: B904
            ...
            raise CommandError(msg)  # pylint: disable=raise-missing-from  # noqa: B904
