...
def runchecks(include_extended=False):
    ...
    for path in list_of_checks:
        ...
        try:
            ...
            raise ImproperlyConfigured(f'Error importing module {module}: "{e}"')  # lint-amnesty, pylint: disable=raise-missing-from  # noqa: B904, E501
        except AttributeError:
            raise ImproperlyConfigured(f'Module "{module}" does not define a "{attr}" callable')  # lint-amnesty, pylint: disable=raise-missing-from  # noqa: B904, E501
