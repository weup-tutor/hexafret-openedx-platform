...
class VisbilityTestCase(OutlineProcessorTestCase):
    ...
    def test_visibility(self):
        at_time = datetime(2020, 5, 21, tzinfo=timezone.utc)  # Exact value doesn't matter  # pylint: disable=unused-variable  # noqa: E501, F841, UP017
...
@patch(
    "openedx.core.djangoapps.content.learning_sequences.api.processors.team_partition_groups.CONTENT_GROUPS_FOR_TEAMS.is_enabled",
    lambda _: True
)
@skip_unless_lms
