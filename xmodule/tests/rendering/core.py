...
@singledispatch
def assert_student_view_valid_html(block, html):  # pylint: disable=unused-argument
    """
...
@singledispatch
def assert_studio_view_valid_html(block, html):  # pylint: disable=unused-argument
    """
...
@singledispatch
def assert_student_view_invalid_html(block, html):  # pylint: disable=unused-argument
    """
    Asserts that the html generated by the `student_view` view is correct for
...
@singledispatch
def assert_studio_view_invalid_html(block, html):  # pylint: disable=unused-argument
    """
    Asserts that the html generated by the `studio_view` view is correct for
    the supplied block
