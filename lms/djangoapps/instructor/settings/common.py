...
def plugin_settings(settings):
    ...
    # .. toggle_name: FEATURES['CERTIFICATES_INSTRUCTOR_GENERATION']  # pylint: disable=annotation-missing-token  # noqa: E501
    # .. toggle_implementation: DjangoSetting
    # .. toggle_default: False
    ...
    # .. toggle_name: FEATURES['ENABLE_CERTIFICATES_INSTRUCTOR_MANAGE]  # pylint: disable=annotation-missing-token  # noqa: E501
    # .. toggle_implementation: DjangoSetting
    # .. toggle_default: False
