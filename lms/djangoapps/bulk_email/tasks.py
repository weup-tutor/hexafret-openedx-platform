    ...
    try:
        ...
        while to_list:
            ...
            try:
                ...
                # This will fall through and not retry the message.
                if exc.response['Error']['Code'] in ['MessageRejected', 'MailFromDomainNotVerified', 'MailFromDomainNotVerifiedException', 'FromEmailAddressNotVerifiedException']:  # noqa: E501
                    total_recipients_failed += 1
                    log.exception(
        ...
        if isinstance(exc, (SMTPDataError, SMTPSenderRefused)) or exc.response['Error']['Code'] in ['LimitExceededException']:  # noqa: E501
