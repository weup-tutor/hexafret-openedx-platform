    ...
    **Response Values**
    ...
    def list(self, request, usage_key_string, hide_access_denials=False):  # pylint: disable=arguments-differ
        ...
        try:
            ...
            raise Http404(f"Block not found: {str(exception)}")  # lint-amnesty, pylint: disable=raise-missing-from  # noqa: B904, E501
    ...
    **Response Values**
    ...
    def list(self, request, hide_access_denials=False):  # pylint: disable=arguments-differ
        ...
        try:
            ...
            raise ValidationError(f"'{str(course_key_string)}' is not a valid course key.")  # lint-amnesty, pylint: disable=raise-missing-from  # noqa: B904, E501
    ...
    **Response Values**
    ...
    def list(self, request, usage_key_string):  # pylint: disable=arguments-differ
        ...
        try:
            ...
            raise ValidationError(f"'{str(usage_key_string)}' is not a valid usage key.")  # lint-amnesty, pylint: disable=raise-missing-from  # noqa: B904, E501
