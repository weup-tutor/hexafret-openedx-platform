...
class BlockListGetForm(Form):
    ...
    def clean_depth(self):
        ...
        try:
            ...
            raise ValidationError(f"'{value}' is not a valid depth value.")  # lint-amnesty, pylint: disable=raise-missing-from  # noqa: B904, E501
    ...
    def clean_usage_key(self):
        ...
        try:
            ...
            raise ValidationError(f"'{str(usage_key)}' is not a valid usage key.")  # lint-amnesty, pylint: disable=raise-missing-from  # noqa: B904, E501
