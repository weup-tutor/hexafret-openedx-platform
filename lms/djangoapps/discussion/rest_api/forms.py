...
class ThreadListGetForm(_PaginationForm):
    ...
    def clean_course_id(self):
        ...
        try:
            ...
            raise ValidationError(f"'{value}' is not a valid course id")  # lint-amnesty, pylint: disable=raise-missing-from  # noqa: B904, E501
...
class CourseDiscussionSettingsForm(Form):
    ...
    def clean_course_id(self):
        ...
        try:
            ...
            raise ValidationError(f"'{str(course_id)}' is not a valid course key")  # lint-amnesty, pylint: disable=raise-missing-from  # noqa: B904, E501
