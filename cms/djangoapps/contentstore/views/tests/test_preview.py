...
class GetPreviewHtmlTestCase(ModuleStoreTestCase):
    ...
    def test_preview_fragment(self):
        ...
        self.assertRegex(html, '<html>foobar</html>')  # noqa: PT009
        self.assertRegex(html, r"data-block-type=[\"\']test_aside[\"\']")  # noqa: PT009
        self.assertRegex(html, "Aside rendered")  # noqa: PT009
        # Now ensure the acid_aside is not in the result
        self.assertNotRegex(html, r"data-block-type=[\"\']acid_aside[\"\']")  # noqa: PT009
        ...
        self.assertNotRegex(html, r"data-block-type=[\"\']test_aside[\"\']")  # noqa: PT009
        self.assertNotRegex(html, "Aside rendered")  # noqa: PT009
    ...
    def test_block_branch_not_changed_by_preview_handler(self):
        ...
        response = client.post(url)
        self.assertEqual(response.status_code, 200)  # noqa: PT009
        self.assertFalse(modulestore().has_changes(modulestore().get_item(block.location)))  # noqa: PT009
...
class StudioXBlockServiceBindingTest(ModuleStoreTestCase):
    ...
    def test_expected_services_exist(self, expected_service):
        ...
        self.assertIsNotNone(service)  # noqa: PT009
