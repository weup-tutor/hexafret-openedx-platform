...
class EnsureUserInformationTestCase(TestCase):
    ...
    def test_provider_settings_redirect_to_registration(self, send_to_registration_first, expected_redirect_url):
        ...
        with mock.patch('common.djangoapps.third_party_auth.pipeline.provider.Registry.get_from_pipeline') as get_from_pipeline:  # noqa: E501
...
class UserDetailsForceSyncTestCase(TestCase):
    ...
    def setUp(self):
        ...
        get_from_pipeline = mock.patch('common.djangoapps.third_party_auth.pipeline.provider.Registry.get_from_pipeline')  # noqa: E501
...
class SetIDVerificationStatusTestCase(TestCase):
    ...
    def test_set_id_verification_status_expired(self):
        ...
        with mock.patch('common.djangoapps.third_party_auth.pipeline.earliest_allowed_verification_date') as earliest_date:  # noqa: E501
