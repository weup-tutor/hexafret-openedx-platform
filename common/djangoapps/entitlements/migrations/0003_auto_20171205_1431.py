    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiration_period', models.DurationField(default=datetime.timedelta(450), help_text='Duration in days from when an entitlement is created until when it is expired.')),
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, to='student.CourseEnrollment', help_text='The current Course enrollment for this entitlement. If NULL the Learner has not enrolled.', null=True, on_delete=models.CASCADE),
        ),
        migrations.AlterField(
            model_name='courseentitlement',
            name='expired_at',
            field=models.DateTimeField(help_text='The date that an entitlement expired, if NULL the entitlement has not expired.', null=True, blank=True),
        ),
        migrations.AddField(
            model_name='courseentitlement',
            name='_policy',
