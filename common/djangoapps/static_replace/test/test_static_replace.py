...
def test_static_url_with_query(mock_modulestore, mock_storage):
    ...
    pre_text = 'EMBED src ="/static/LAlec04_controller.swf?csConfigFile=/static/LAlec04_config.xml&name1=value1&name2=value2"'  # noqa: E501
    post_text = 'EMBED src ="/c4x/org/course/asset/LAlec04_controller.swf?csConfigFile=%2Fc4x%2Forg%2Fcourse%2Fasset%2FLAlec04_config.xml&name1=value1&name2=value2"'  # noqa: E501
...
def test_static_paths_out(mock_modulestore, mock_storage):
    ...
    * xblock paths are not included in the static_paths_out array.
    ...
    static_course_url = '/c4x/org/course/asset/LAlec04_controller.swf?csConfigFile=%2Fc4x%2Forg%2Fcourse%2Fasset%2FLAlec04_config.xml&name1=value1&name2=value2'  # noqa: E501
    ...
    # xss-lint: disable=python-wrap-html
    post_text = f'EMBED src ="{static_course_url}" xblock={xblock_url} text <tag a="{raw_url}"/><div class="'
    static_paths = []
